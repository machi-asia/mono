...
export const DEFAULT_COMMAND_CATEGORIES: CommandCategory[] = [
  ...
  },
  {
    ...
    description: "Manage index-based long-term memory: learn, recall, remember, forget",
    icon: "Brain",
    items: [
      {
        id: "tool-learn",
        title: "Learn a New Memory",
        subtitle: "Writes a new memory index with a full description",
        category: "tool",
        termBadge: `@tool:"learn"`,
        promptText: `@tool:"learn" `,
      },
      {
        id: "tool-recall",
        title: "Recall a Memory Index",
        subtitle: "Reads the full description of an existing memory index",
        category: "tool",
        termBadge: `@tool:"recall"`,
        promptText: `@tool:"recall" `,
      },
      {
        id: "tool-remember",
        title: "Edit / Update a Memory",
        subtitle: "Replaces the description of an existing memory index",
        category: "tool",
      ...
      {
        id: "tool-forget",
        title: "Forget a Memory Index",
        subtitle: "Deletes a memory index and its details",
        category: "tool",
        termBadge: `@tool:"forget"`,
        promptText: `@tool:"forget" `,
      },
    ],
  },
  {
